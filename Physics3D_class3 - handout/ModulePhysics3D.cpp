...
bool ModulePhysics3D::CleanUp()
{
	...
	p2List_item<btCollisionShape*>*	colliders;
	p2List_item<PhysBody3D*>*		bodies;

	colliders = CollisionContainer.getFirst();
	bodies = ShapeContainer.getFirst();

	while (colliders != nullptr)
	{
		delete colliders->data;
...
PhysBody3D* ModulePhysics3D::AddBody(const Sphere& sphere, float mass)
{
	...
	CollisionContainer.add(colShape);
