...
bool PhysBody::Contains(int x, int y) const
{
	...
	for (b2Fixture* fixture = body->GetFixtureList(); fixture && ret == false; fixture = fixture->GetNext())
	{
...
int PhysBody::RayCast(int x1, int y1, int x2, int y2, float& normal_x, float& normal_y) const
{
	...
	b2Vec2 Vect_1(PIXEL_TO_METERS(x1), PIXEL_TO_METERS(y1));
	b2Vec2 Vect_2(PIXEL_TO_METERS(x2), PIXEL_TO_METERS(y2));
	...
	for (b2Fixture* fixture = body->GetFixtureList(); fixture; fixture = fixture->GetNext())
	{
		...
		if (output.fraction < closestFraction) {
			...
			b2Vec2 intersectionPoint = Vect_1 + closestFraction * (Vect_2 - Vect_1);
