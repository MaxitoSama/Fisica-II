...
ModulePhysics3D::ModulePhysics3D(Application* app, bool start_enabled) : Module(app, start_enabled)
{
	...
	CollComf= new btDefaultCollisionConfiguration();
	CollDis = new btCollisionDispatcher(CollComf);
	BrPhase = new btDbvtBroadphase();
...
bool ModulePhysics3D::Start()
{
	...
	world = new btDiscreteDynamicsWorld(CollDis, BrPhase, Solver, CollComf);
